...
filename = 'low_solar_low_load_6';

sol = load(strcat('solution/EMS4_3/',filename,'.mat')); 
PARAM = sol.PARAM;
...
% print(f,strcat('graph/EMS4_3/png/6_plot_',filename),'-dpng')
% print(f,strcat('graph/EMS4_3/eps/6_plot_',filename),'-deps')