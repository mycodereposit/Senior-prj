function sol = EMS1_opt(PARAM,dataset_name,is_save,save_path) 
    ...
    if is_save == 1
        ...
        save(strcat(save_path,'/EMS1/',num2str(PARAM.battery.num_batt),'batt/',PARAM.TOU_CHOICE,'_',dataset_name,'.mat'),'-struct','sol')
